...
import com.example.myapplication.bean.ItemTitle;
...
public class DragGridView<T extends ItemTitle> extends GridLayout implements View.OnLongClickListener, View.OnClickListener {
    ...
    private static final int DEFAULT_TEXT_NORMAL_BACKGROUND =0;//= R.drawable.lib_tv_bg_normal;
    private static final int DEFAULT_TEXT_SELECTED_BACKGROUND =0;//= R.drawable.lib_tv_bg_selected;
